import{$ as e,E as t,F as n,H as r,K as i,N as a,Q as o,S as s,X as c,Z as l,_ as u,d,g as f,h as p,l as m,m as h,n as g,t as _,v,x as y}from"./WinScrollViewer-Cel0kV6s.js";import{n as b,t as x}from"./WinToggleButton-Dj-8G30B.js";import{t as S}from"./WinControlExample-CxPQLLlF.js";import{t as C}from"./pageState-gpY_Fsb6.js";var ee={class:`gallery-item-page`},te={style:{position:`relative`},class:`page-heading`},ne={class:`page-header-actions`},re={class:`icon`},ie={class:`gallery-page-content`},ae={class:`example-container`},w={class:`menu-bar`},T={class:`menu-bar-item`},E={key:0,class:`menu-flyout`},D={class:`menu-bar-item`},O={key:0,class:`menu-flyout`},k={class:`menu-bar-item`},A={key:0,class:`menu-flyout`},j={class:`list-view`},M=[`onClick`,`onContextmenu`,`onMouseenter`],N={class:`list-item-text`},P=`<div class="menu-bar">
