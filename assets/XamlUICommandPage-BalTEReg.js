import{$ as e,E as t,H as n,K as r,N as i,S as a,X as o,h as s,m as c,n as l,t as u,v as d}from"./WinScrollViewer-Cel0kV6s.js";import{n as f,t as p}from"./WinToggleButton-Dj-8G30B.js";import{t as m}from"./WinControlExample-CxPQLLlF.js";import{t as h}from"./pageState-gpY_Fsb6.js";import{t as g}from"./WinAppBarButton-DUNB2Ttg.js";var _={class:`gallery-item-page`},v={style:{position:`relative`},class:`page-heading`},y={class:`page-header-actions`},b={class:`icon`},x={class:`gallery-page-content`},S={style:{display:`flex`,"flex-direction":`column`,gap:`12px`}},C={style:{display:`flex`,"align-items":`center`,gap:`8px`}},w={class:`output-text`},T=`This is a custom command (Ctrl+D)`,E=`<div style="display: flex; align-items: center; gap: 8px;">
  <WinAppBarButton
    icon="Favorite"
