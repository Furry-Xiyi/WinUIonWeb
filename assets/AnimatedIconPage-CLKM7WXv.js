import{$ as e,E as t,H as n,K as r,N as i,Q as a,S as o,X as s,h as c,m as l,n as u,t as d,v as f,x as p}from"./WinScrollViewer-Cel0kV6s.js";import{n as m,t as h}from"./WinToggleButton-Dj-8G30B.js";import{t as g}from"./WinControlExample-CxPQLLlF.js";import{t as _}from"./WinComboBox-DKZeGs7P.js";import{t as v}from"./pageState-gpY_Fsb6.js";import{t as y}from"./WinAnimatedVisualPlayer-DLbO4gNd.js";var b={class:`gallery-item-page`},x={style:{position:`relative`},class:`page-heading`},S={class:`page-header-actions`},C={class:`icon`},w={class:`gallery-page-content`},T={style:{display:`flex`,"flex-direction":`column`,gap:`16px`,"align-items":`flex-start`}},E={style:{display:`flex`,"flex-direction":`column`,gap:`8px`}},D={style:{display:`flex`,"flex-direction":`column`,gap:`16px`}},O={style:{padding:`12px`,border:`1px solid var(--ctrl-border-rest)`,"border-radius":`8px`,background:`var(--card-bg-secondary)`}},k={style:{width:`32px`,height:`32px`,display:`flex`,"align-items":`center`,"justify-content":`center`}},A=`<WinButton @mouseenter="onButtonPointerEntered"
