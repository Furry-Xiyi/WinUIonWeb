import{$ as e,D as t,E as n,F as r,H as i,K as a,N as o,Q as s,S as c,X as l,d as u,g as d,h as f,m as p,n as m,t as h,v as g}from"./WinScrollViewer-Cel0kV6s.js";import{t as _}from"./WinTextBlock-CUbW5hkh.js";import{r as v}from"./i18n-DnD06S2j.js";import{a as y}from"./index-BYjt0VYv.js";import{n as b,t as x}from"./WinToggleButton-Dj-8G30B.js";import{t as S}from"./WinControlExample-CxPQLLlF.js";import{t as C}from"./pageState-gpY_Fsb6.js";import{t as w}from"./WinFlyout-DFU9m08K.js";import{t as T}from"./WinRichEditBox-neFP6MGK.js";var E={class:`gallery-item-page`},ee={style:{position:`relative`},class:`page-heading`},te={class:`page-header-actions`},D={class:`icon`},O={class:`gallery-page-content`},k={class:`official-custom-editor`},A={class:`official-toolbar`},j={class:`toolbar-start`},M={class:`toolbar-end`},N={class:`font-color-flyout`},P=[`aria-label`,`onClick`],F={class:`official-find-row`},I={class:`stack-example`},L={class:`stack-example`},R={class:`mathml-output-pre`},z=m({__name:`RichEditBoxPage`,setup(m){let{t:z}=v(),B=n(`currentPage`),{isFavoriteState:V,pageTheme:H,toggleTheme:ne,toggleFavorite:U}=C(p(()=>B?.value||`richeditbox`).value),W=a(``),G=a(``),K=a(``),q=a(``),J=a(``),Y=a(`<!-- ${z(`sample.richeditbox.no-mathml`)} -->`),X=a(null),Z=a(null),re=p(()=>[{value:`Red`,label:z(`text.red`)},{value:`Orange`,label:z(`sample.orange`)},{value:`Yellow`,label:z(`text.yellow`)},{value:`Green`,label:z(`text.green`)},{value:`Blue`,label:z(`text.blue`)},{value:`Indigo`,label:z(`sample.indigo`)},{value:`Violet`,label:z(`sample.violet`)},{value:`Gray`,label:z(`sample.gray`)}]),ie=p(()=>[{Label:z(`sample.richeditbox.share-command`),Icon:`Share`,"ToolTipService.ToolTip":z(`sample.richeditbox.share-command`),Click:ae}]),Q=e=>{console.log(`${e} clicked`)},ae=()=>{console.log(z(`sample.richeditbox.share-clicked`))},oe=e=>{X.value?.execCommand(`foreColor`,e),Z.value?.hide?.()},$=()=>{let e=J.value;Y.value=e.trim()?`<!-- ${z(`sample.richeditbox.web-preview`)} -->\n${e}`:`<!-- ${z(`sample.richeditbox.no-mathml`)} -->`},se=()=>{J.value=`x ∈ P(A) ↔ x ⊆ A`,Y.value=`<math xmlns="http://www.w3.org/1998/Math/MathML" display="block">
  <mi>x</mi>
  <mo>∈</mo>
  <mi>P</mi>
