import{$ as e,E as t,H as n,K as r,N as i,Q as a,S as o,X as s,g as c,h as l,m as u,n as d,t as f,x as p}from"./WinScrollViewer-DPrZnleG.js";import{c as m,r as h}from"./index-bVh3HLQD.js";import{t as g}from"./WinControlExample-QF8pUbRM.js";import{t as _}from"./WinSlider-CK8OpsOs.js";import{t as v}from"./pageState-Mr-1-Xo1.js";import{t as y}from"./WinRadioButton-DE2lRBbQ.js";var b={class:`gallery-item-page`},x={style:{position:`relative`},class:`page-heading`},S={class:`page-header-actions`},C={class:`icon`},w={class:`gallery-page-content`},T={style:{display:`flex`,"flex-direction":`column`,gap:`16px`}},E={style:{display:`grid`,"grid-template-columns":`1fr 1fr`,gap:`16px`}},D={style:{display:`flex`,"flex-direction":`column`,gap:`4px`}},O={style:{display:`flex`,"flex-direction":`column`,gap:`4px`}},k=`const borderThickness = ref(2);
