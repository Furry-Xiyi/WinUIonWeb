import{$ as e,C as t,E as n,H as r,K as i,N as a,S as o,T as s,X as c,g as l,h as u,m as d,n as f,t as p}from"./WinScrollViewer-Cel0kV6s.js";import{t as m}from"./WinTextBlock-CUbW5hkh.js";import{r as h}from"./i18n-DnD06S2j.js";import{n as g,t as _}from"./WinToggleButton-Dj-8G30B.js";import{t as v}from"./WinControlExample-CxPQLLlF.js";import{t as y}from"./pageState-gpY_Fsb6.js";import{t as b}from"./WinCheckBox-Cu7z4tu7.js";import{t as x}from"./WinContentDialog-C73p4Ycl.js";var S={class:`gallery-item-page`},C={class:`page-heading`},w={class:`page-header-actions`},T={class:`icon`},E={class:`gallery-page-content`},D={class:`sample-row`},O={class:`sample-row`},k=f({__name:`ContentDialogPage`,setup(f){let{t:k}=h(),A=n(`currentPage`),{isFavoriteState:j,pageTheme:M,toggleTheme:N,toggleFavorite:P}=y(d(()=>A?.value||`contentdialog`).value),F=i(!1),I=i(!1),L=i(``),R=i(``),z=t({setup(){return()=>s(`div`,{class:`dialog-content-stack`},[s(m,{Text:k(`sample.contentdialog.body`),FontSize:14,FontWeight:400,TextWrapping:`WrapWholeWords`}),s(b,null,{default:()=>s(m,{Text:k(`sample.contentdialog.upload`),FontSize:14,FontWeight:400})})])}}),B=d(()=>`<WinButton @Click="showDialog = true">
