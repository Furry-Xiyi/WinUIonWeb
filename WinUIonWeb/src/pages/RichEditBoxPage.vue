<template>
  <div>
    <div style="position: relative;">
      <WinTextBlock class="page-header" Text="RichEditBox" />
      <WinTextBlock class="page-description" Text="The RichEditBox control lets a user enter formatted text such as bold, italic, and underlined. RichEditBox can also display and edit Rich Text Format (.rtf) files." TextWrapping="WrapWholeWords" />
    ...
    <WinTextBlock class="control-example-description" Text="A simple text editor" />
    <WinControlExample class="basic-input-example-theme" :theme="pageTheme" horizontalContentAlignment="Stretch" :vue="example1Template">
      <template #example>
        <WinRichEditBox v-model:Text="simpleText" PlaceholderText="Enter rich text" />
      </template>
    </WinControlExample>
