    ...
    <WinScrollViewer class="gallery-page-scroll" VerticalScrollBarVisibility="Auto" VerticalScrollMode="Auto">
      <div class="gallery-page-content">
            ...
            <WinControlExample class="basic-input-example-theme" horizontalContentAlignment="Stretch" :headerText="$t('sample.itemsrepeater.virtualizing-scrollable-list-items')" :theme="pageTheme" :vue="virtualizingRepeaterVue">
              <template #example>
                <div class="scroll-host feed-host">
            ...
            <WinControlExample class="basic-input-example-theme" :headerText="$t('sample.itemsrepeater.nested')" :theme="pageTheme" :vue="nestedRepeaterVue">
              <template #example>
                <div class="scroll-host nested-scroll">
            ...
            <WinControlExample class="basic-input-example-theme" :headerText="$t('sample.itemsrepeater.animated-scrolling-content-display')" :theme="pageTheme" :vue="animatedRepeaterVue">
              <template #example>
                <div class="animated-grid">
                  <div class="scroll-host animated-list" @scroll="Animated_ScrollViewer_ViewChanging">
            ...
            <WinControlExample class="basic-input-example-theme" :headerText="$t('sample.itemsrepeater.virtualized-content-heavy-layout')" :theme="pageTheme" :vue="contentHeavyRepeaterVue">
              <template #example>
                <div class="recipe-grid">
                  <div class="scroll-host recipe-host">
...
const Animated_ScrollViewer_ViewChanging = (event) => {
  const host = event.currentTarget;
  animatedScrollTop.value = host.scrollTop;
  const buttons = Array.from(host.querySelectorAll('.color-button'));
  if (!buttons.length) return;
  const centerY = host.scrollTop + host.clientHeight / 2;
  let closest = buttons[0];
  let closestDistance = Infinity;
  for (const button of buttons) {
    const itemCenter = button.offsetTop + button.offsetHeight / 2;
  ...
  selectedColor.value = closest.textContent.trim();
};
...
.scroll-host { overflow: auto; max-width: 100%; scrollbar-width: thin; }
...
.nested-scroll { overflow-x: auto; overflow-y: hidden; }
