  ...
  <ScrollViewer class="gallery-page-scroll" VerticalScrollBarVisibility="Auto" VerticalScrollMode="Auto">
    <div class="gallery-item-page">
      <div class="page-heading">
          <TextBlock class="page-header" :Text="$t('text.itemsview')" />
          <TextBlock class="page-description" :Text="$t('text.itemsview-description')" TextWrapping="WrapWholeWords" />
      ...
      <div class="gallery-page-content">
        <ControlExample class="basic-input-example-theme" :headerText="$t('sample.itemsview.basic')" :theme="pageTheme" :vue="basicItemsViewVue">
              <template #example>
                <div class="sample-stack">
                  <TextBlock Margin="0,0,0,15" :Text="$t('sample.itemsview.basic-note')" TextWrapping="WrapWholeWords" />
                  <ItemsView
                  ...
                  <TextBlock class="output-text" :Text="basicInvokeOutput" />
                </div>
              </template>
            </ControlExample>

            <ControlExample class="basic-input-example-theme" :headerText="$t('sample.itemsview.swappable-layouts')" :theme="pageTheme" :vue="swappableLayoutsVue">
              <template #example>
                <div class="sample-stack">
                  <TextBlock Margin="0,0,0,15" :Text="$t('sample.itemsview.layout-note')" TextWrapping="WrapWholeWords" />
                  <ItemsView
                    ...
                    <template #item="{ item }">
                      <div class="layout-template" :class="layoutClass" :aria-label="item.Title">
                        ...
                        <div class="item-overlay">
                          <TextBlock class="overlay-title" :Text="item.Title" />
                          <div class="overlay-row">
                            <TextBlock class="overlay-caption" :Text="String(item.Likes)" />
                            <TextBlock class="overlay-caption" :Text="$t('sample.likes-suffix')" />
                          </div>
                        </div>
                        <div class="stack-text">
                          <TextBlock class="stack-title" :Text="item.Title" />
                          <TextBlock class="stack-description" :Text="item.Description" TextWrapping="WrapWholeWords" />
                        </div>
                      </div>
                    </template>
                  </ItemsView>
              ...
              <template #options>
                <div class="options-stack">
                  <RadioButtons :Header="$t('sample.layout')" :ItemsSource="layoutOptions" :SelectedIndex="layoutSelectedIndex" @SelectionChanged="RbLayout_Checked" />

                  <div v-if="layoutSelection === 'LinedFlowLayout'" class="options-stack">
                    <TextBlock class="options-heading" :Text="$t('sample.itemsview.linedflow-settings')" />
                    <NumberBox v-model:Value="lineSpacing" :Header="$t('sample.space-between-lines')" :Minimum="0" :Maximum="100" SpinButtonPlacementMode="Inline" />
                    <NumberBox v-model:Value="minItemSpacing" :Header="$t('sample.minimum-space-between-items-on-line')" :Minimum="0" :Maximum="100" SpinButtonPlacementMode="Inline" />
                    <RadioButtons :Header="$t('sample.line-height')" :ItemsSource="lineHeightOptions" :SelectedIndex="lineHeightSelectedIndex" @SelectionChanged="RbLineHeight_Checked" />
                  </div>

                  <div v-else-if="layoutSelection === 'StackLayout'" class="options-stack">
                    <TextBlock class="options-heading" :Text="$t('sample.itemsview.stack-settings')" />
                    <NumberBox v-model:Value="stackSpacing" :Header="$t('sample.space-between-rows')" :Minimum="0" :Maximum="100" SpinButtonPlacementMode="Inline" />
                  </div>

                  <div v-else class="options-stack">
                    <TextBlock class="options-heading" :Text="$t('sample.itemsview.uniformgrid-settings')" />
                    <NumberBox v-model:Value="minColumnSpacing" :Header="$t('sample.minimum-space-between-columns')" :Minimum="0" :Maximum="100" SpinButtonPlacementMode="Inline" />
                    <NumberBox v-model:Value="minRowSpacing" :Header="$t('sample.minimum-space-between-rows')" :Minimum="0" :Maximum="100" SpinButtonPlacementMode="Inline" />
                    <NumberBox v-model:Value="maximumRowsOrColumns" :Header="$t('sample.maximum-items-per-row-before-wrapping')" :Minimum="1" :Maximum="8" SpinButtonPlacementMode="Inline" />
                  </div>
                </div>
              </template>
            </ControlExample>

            <ControlExample class="basic-input-example-theme" :headerText="$t('sample.itemsview.item-invocation-selection')" :theme="pageTheme" :vue="selectionItemsViewVue">
              <template #example>
                <div class="sample-stack">
                  <div class="selection-note">
                    <TextBlock :Text="$t('sample.itemsview.selection-note-1')" TextWrapping="WrapWholeWords" />
                    <TextBlock :Text="$t('sample.itemsview.selection-note-none')" TextWrapping="WrapWholeWords" />
                    <TextBlock :Text="$t('sample.itemsview.selection-note-single')" TextWrapping="WrapWholeWords" />
                    <TextBlock :Text="$t('sample.itemsview.selection-note-multiple')" TextWrapping="WrapWholeWords" />
                    <TextBlock :Text="$t('sample.itemsview.selection-note-extended')" TextWrapping="WrapWholeWords" />
                  </div>
                  <ItemsView
                  ...
                  <TextBlock class="output-text" :Text="invocationOutput" />
                  <TextBlock class="output-text" :Text="selectionOutput" />
                </div>
              </template>
              <template #options>
                <div class="selection-options">
                  <TextBlock :Text="$t('sample.selection-mode')" />
                  <ComboBox v-model:SelectedIndex="selectionModeSelectedIndex" :ItemsSource="selectionModeOptions" DisplayMemberPath="Text" />
                  <TextBlock :Text="$t('sample.is-item-invoked-enabled')" />
                  <CheckBox v-model:IsChecked="isItemInvokedEnabled" />
                </div>
              </template>
            </ControlExample>
      </div>
...
const basicItemsViewVue = `<ItemsView
  :ItemsSource="items"
  :IsItemInvokedEnabled="true"
  @ItemInvoked="BasicItemsView_ItemInvoked">
  <template #item="{ item }">
...
const swappableLayoutsVue = `<ItemsView :ItemsSource="items" :Layout="itemsViewLayout">
  <template #item="{ item }">
    <img :src="item.ImageLocation" :alt="item.Title" />
...
const selectionItemsViewVue = `<ItemsView
  :ItemsSource="items"
