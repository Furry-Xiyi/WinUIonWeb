<template>
  <h1 class="page-header">{{ $t('text.splitview') }}</h1>
  <p class="page-description">{{ $t('text.a-container-with-two-views-one-view-for-the-main') }}</p>

  <WinControlExample :headerText="$t('text.a-basic-splitview')">
    <template #example>
...
const displayModeOptions = [
  { label: t('text.inline') },
  { label: t('text.compactinline') },
  { label: t('text.overlay') },
  { label: t('text.compactoverlay') }
];
const paneBgOptions = [
  { label: t('text.systembackground') },
  { label: t('text.red') },
  { label: t('text.blue') },
  { label: t('text.green') }
];
...
const navItems = ref([
  { icon: '\uE80F', label: t('text.home') },
  { icon: '\uE716', label: t('text.account') },
  { icon: '\uE8A5', label: t('text.documents') },
  { icon: '\uE713', label: t('text.settings') }
]);
