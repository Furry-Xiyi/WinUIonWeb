<template>
  <div>
    ...
    <WinControlExample class="basic-input-example-theme" :headerText="$t('text.a-menuflyout-attached-to-an-appbarbutton')" :theme="pageTheme" :vue="sortCode">
      <template #example>
        <div class="sample-row">
          <WinAppBarButton icon="&#xE8CB;" :label="$t('text.sort')" :isCompact="true" @click="openMenu($event, sortMenu)" />
        </div>
      </template>
