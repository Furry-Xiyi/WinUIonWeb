<template>
  <div>
    <div style="position: relative;">
      <h1 class="page-header">{{ $t('text.colorpicker') }}</h1>
      <p class="page-description">
        {{ $t('text.a-control-that-lets-users-pick-a-color-from-a-sp') }}
      </p>
    ...
    <p class="control-example-description">{{ $t('text.a-simple-colorpicker') }}</p>
