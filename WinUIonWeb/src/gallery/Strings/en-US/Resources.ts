export default {
  ...
  "text.the-menubar-simplifies-the-creation-of-basic-men": "The MenuBar simplifies the creation of basic menu systems for apps. It works out of the box with little customization, supports keyboard accelerators, and automatically adjusts UI for different input types and devices.",
  ...
  ,"sample.itemsrepeater.virtualizing-scrollable-list-items": "Virtualizing scrollable list items"
  ...
  ,"sample.itemsrepeater.animated-scrolling-content-display": "Animated scrolling content display"
  ,"sample.itemsrepeater.virtualized-content-heavy-layout": "Virtualized content-heavy layout"
  ...
  ,"sample.itemsview.selection-note-single": "Single allows for only one item to be selected in the collection."
  ,"sample.itemsview.selection-note-multiple": "Multiple causes checkboxes to appear within the items, so that multiple items can be chosen from the collection."
  ...
  ,"sample.pulltorefresh.refresh-count": "Refresh count"
  ,"sample.pulltorefresh.sync-count": "Sync count"
  ...
  ,"sample.slider.vertical": "A vertical Slider."
  ...
  ,"sample.richeditbox.custom-command-flyout": "Customizing the RichEditBox command bar flyout by adding commands"
  ,"sample.richeditbox.custom-formatting-editor": "A custom editor with formatting"
  ...
  ,"sample.menuflyout.toggle-items": "A MenuFlyout with toggle items"
  ,"sample.menuflyout.cascading": "A MenuFlyout with cascading submenus"
  ,"sample.menuflyout.split-items": "A MenuFlyout with split menu items"
  ...
  ,"sample.media.transport-controls": "A MediaPlayerElement with transport controls."
  ,"sample.media.autoplay-video": "A MediaPlayerElement that autoplays the video."
  ...
  ,"sample.parallaxview.listview": "Parallax with a ListView"
