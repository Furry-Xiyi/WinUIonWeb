export default {
  ...
  ,"sample.itemsrepeater.virtualizing-scrollable-list-items": "虚拟化可滚动列表项目"
  ,"sample.itemsrepeater.mixed-type-collection": "包含混合类型集合的 ItemsRepeater"
  ,"sample.itemsrepeater.nested": "布局嵌套 ItemsRepeater"
  ,"sample.itemsrepeater.animated-scrolling-content-display": "动画滚动内容显示"
  ,"sample.itemsrepeater.virtualized-content-heavy-layout": "虚拟化的内容密集型布局"
  ...
  ,"sample.itemsview.selection-note-multiple": "Multiple 会在项目中显示复选框，以便从集合中选择多个项目。"
  ...
  ,"sample.pulltorefresh.refresh-count": "刷新次数"
  ,"sample.pulltorefresh.sync-count": "同步次数"
  ...
  ,"sample.richeditbox.custom-command-flyout": "通过添加命令来自定义 RichEditBox 命令栏浮出控件"
  ,"sample.richeditbox.custom-formatting-editor": "带格式设置的自定义编辑器"
  ...
  ,"sample.menuflyout.toggle-items": "带切换项的 MenuFlyout"
  ,"sample.menuflyout.cascading": "带级联子菜单的 MenuFlyout"
  ,"sample.menuflyout.split-items": "带拆分菜单项的 MenuFlyout"
  ...
  ,"sample.true": "True"
  ,"sample.false": "False"
  ,"sample.teachingtip.targeted": "在按钮上显示定向 TeachingTip。"
  ,"sample.teachingtip.non-targeted": "显示带按钮的非定向 TeachingTip。"
  ,"sample.teachingtip.hero": "在按钮上显示带主图内容的定向 TeachingTip。"
  ...
  ,"sample.media.transport-controls": "带传输控件的 MediaPlayerElement。"
  ,"sample.media.autoplay-video": "自动播放视频的 MediaPlayerElement。"
  ,"sample.media.open-file": "打开文件"
  ,"sample.personpicture.select-looks": "为人物头像选择不同外观。"
  ,"sample.personpicture.profile-type": "配置文件类型"
  ,"sample.personpicture.profile-image": "配置文件图像"
  ,"sample.personpicture.display-name": "显示名称"
  ,"sample.personpicture.initials": "缩写"
  ,"text.canvas": "Canvas"
  ,"text.grid": "Grid"
  ...
  ,"sample.stackpanel.control": "一个 StackPanel 控件。"
  ,"sample.relativepanel.control": "一个 RelativePanel 控件。"
  ,"sample.variablesizedwrapgrid.control": "VariableSizedWrapGrid"
  ,"sample.viewbox.content": "Viewbox 中的内容。"
